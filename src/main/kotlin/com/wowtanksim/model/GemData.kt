...
object GemData {
    ...
    private val redGems = listOf(
        ...
        // Heroic dungeon drops — Orange (duplicated in yellowGems)
        GemOption(Gem(id = 30593, name = "Iridescent Fire Opal", icon = "inv_jewelcrafting_nobletopaz_03", color = GemColor.RED), note = "+11 Heal / +4 SP Crit", source = "HC: Ramparts", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30601, name = "Beaming Fire Opal", icon = "inv_jewelcrafting_nobletopaz_03", color = GemColor.RED, dodgeRating = 5, resilienceRating = 4), note = "+5 Dodge / +4 Resil", source = "HC: Blood Furnace", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30547, name = "Luminous Fire Opal", icon = "inv_jewelcrafting_nobletopaz_03", color = GemColor.RED, intellect = 4), note = "+11 Heal / +4 Int", source = "HC: Shattered Halls", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30604, name = "Resplendent Fire Opal", icon = "inv_jewelcrafting_nobletopaz_03", color = GemColor.RED, strength = 5, resilienceRating = 4), note = "+5 Str / +4 Resil", source = "HC: Slave Pens", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30607, name = "Splendid Fire Opal", icon = "inv_jewelcrafting_nobletopaz_03", color = GemColor.RED, resilienceRating = 4), note = "+5 Parry / +4 Resil", source = "HC: Underbog", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30551, name = "Infused Fire Opal", icon = "inv_jewelcrafting_nobletopaz_03", color = GemColor.RED, intellect = 4), note = "+6 SP / +4 Int", source = "HC: Steamvault", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30584, name = "Enscribed Fire Opal", icon = "inv_jewelcrafting_nobletopaz_03", color = GemColor.RED, strength = 5, critRating = 4), note = "+5 Str / +4 Crit", source = "HC: Mana-Tombs", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30585, name = "Glistening Fire Opal", icon = "inv_jewelcrafting_nobletopaz_03", color = GemColor.RED, agility = 4, defenseRating = 5), note = "+4 Agi / +5 Def", source = "HC: Mana-Tombs", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30587, name = "Champion's Fire Opal", icon = "inv_jewelcrafting_nobletopaz_03", color = GemColor.RED, strength = 5, defenseRating = 4), note = "+5 Str / +4 Def", source = "HC: Auchenai Crypts", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30588, name = "Potent Fire Opal", icon = "inv_jewelcrafting_nobletopaz_03", color = GemColor.RED), note = "+6 SP / +4 SP Crit", source = "HC: Auchenai Crypts", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30553, name = "Pristine Fire Opal", icon = "inv_jewelcrafting_nobletopaz_03", color = GemColor.RED, attackPower = 10, hitRating = 4), note = "+10 AP / +4 Hit", source = "HC: Sethekk Halls", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30554, name = "Stalwart Fire Opal", icon = "inv_jewelcrafting_nobletopaz_03", color = GemColor.RED, defenseRating = 5, dodgeRating = 4), note = "+5 Def / +4 Dodge", source = "HC: Sethekk Halls", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30559, name = "Etched Fire Opal", icon = "inv_jewelcrafting_nobletopaz_03", color = GemColor.RED, strength = 5, hitRating = 4), note = "+5 Str / +4 Hit", source = "HC: Shadow Lab", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30591, name = "Empowered Fire Opal", icon = "inv_jewelcrafting_nobletopaz_03", color = GemColor.RED, attackPower = 8, resilienceRating = 5), note = "+8 AP / +5 Resil", source = "HC: Old Hillsbrad", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30556, name = "Glinting Fire Opal", icon = "inv_jewelcrafting_nobletopaz_03", color = GemColor.RED, agility = 5, hitRating = 4), note = "+5 Agi / +4 Hit", source = "HC: Black Morass", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30558, name = "Glimmering Fire Opal", icon = "inv_jewelcrafting_nobletopaz_03", color = GemColor.RED, defenseRating = 4), note = "+5 Parry / +4 Def", source = "HC: Black Morass", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30564, name = "Shining Fire Opal", icon = "inv_jewelcrafting_nobletopaz_03", color = GemColor.RED), note = "+6 SP / +5 SP Hit", source = "HC: Mechanar", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30565, name = "Assassin's Fire Opal", icon = "inv_jewelcrafting_nobletopaz_03", color = GemColor.RED, critRating = 6, dodgeRating = 5), note = "+6 Crit / +5 Dodge", source = "HC: Mechanar", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30573, name = "Mysterious Fire Opal", icon = "inv_jewelcrafting_nobletopaz_03", color = GemColor.RED), note = "+6 SP / +5 Spell Pen", source = "HC: Botanica", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30575, name = "Nimble Fire Opal", icon = "inv_jewelcrafting_nobletopaz_03", color = GemColor.RED, dodgeRating = 5, hitRating = 4), note = "+5 Dodge / +4 Hit", source = "HC: Arcatraz", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30581, name = "Durable Fire Opal", icon = "inv_jewelcrafting_nobletopaz_03", color = GemColor.RED, resilienceRating = 4), note = "+11 Heal / +4 Resil", source = "HC: Arcatraz", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30582, name = "Deadly Fire Opal", icon = "inv_jewelcrafting_nobletopaz_03", color = GemColor.RED, attackPower = 8, critRating = 5), note = "+8 AP / +5 Crit", source = "HC: Arcatraz", quality = GemQuality.EPIC, heroicDrop = true),
        // Heroic dungeon drops — Purple (duplicated in blueGems)
        GemOption(Gem(id = 30549, name = "Shifting Tanzanite", icon = "inv_jewelcrafting_nightseye_03", color = GemColor.RED, agility = 5, stamina = 6), note = "+5 Agi / +6 Sta", source = "HC: Steamvault", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30600, name = "Fluorescent Tanzanite", icon = "inv_jewelcrafting_nightseye_03", color = GemColor.RED, spirit = 4), note = "+6 SP / +4 Spi", source = "HC: Blood Furnace", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30603, name = "Royal Tanzanite", icon = "inv_jewelcrafting_nightseye_03", color = GemColor.RED), note = "+11 Heal / +2 MP5", source = "HC: Slave Pens", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30552, name = "Blessed Tanzanite", icon = "inv_jewelcrafting_nightseye_03", color = GemColor.RED, stamina = 6), note = "+11 Heal / +6 Sta", source = "HC: Sethekk Halls", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30563, name = "Regal Tanzanite", icon = "inv_jewelcrafting_nightseye_03", color = GemColor.RED, dodgeRating = 5, stamina = 6), note = "+5 Dodge / +6 Sta", source = "HC: Shadow Lab", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30555, name = "Glowing Tanzanite", icon = "inv_jewelcrafting_nightseye_03", color = GemColor.RED, stamina = 6), note = "+6 SP / +6 Sta", source = "HC: Black Morass", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30566, name = "Defender's Tanzanite", icon = "inv_jewelcrafting_nightseye_03", color = GemColor.RED, stamina = 6), note = "+5 Parry / +6 Sta", source = "HC: Mechanar", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30572, name = "Imperial Tanzanite", icon = "inv_jewelcrafting_nightseye_03", color = GemColor.RED, spirit = 5), note = "+9 Heal / +5 Spi", source = "HC: Botanica", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30574, name = "Brutal Tanzanite", icon = "inv_jewelcrafting_nightseye_03", color = GemColor.RED, attackPower = 10, stamina = 6), note = "+10 AP / +6 Sta", source = "HC: Botanica", quality = GemQuality.EPIC, heroicDrop = true),
    )
    ...
    private val blueGems = listOf(
        ...
        // Heroic dungeon drops — Purple (duplicated in redGems)
        GemOption(Gem(id = 30549, name = "Shifting Tanzanite", icon = "inv_jewelcrafting_nightseye_03", color = GemColor.BLUE, agility = 5, stamina = 6), note = "+5 Agi / +6 Sta", source = "HC: Steamvault", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30600, name = "Fluorescent Tanzanite", icon = "inv_jewelcrafting_nightseye_03", color = GemColor.BLUE, spirit = 4), note = "+6 SP / +4 Spi", source = "HC: Blood Furnace", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30603, name = "Royal Tanzanite", icon = "inv_jewelcrafting_nightseye_03", color = GemColor.BLUE), note = "+11 Heal / +2 MP5", source = "HC: Slave Pens", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30552, name = "Blessed Tanzanite", icon = "inv_jewelcrafting_nightseye_03", color = GemColor.BLUE, stamina = 6), note = "+11 Heal / +6 Sta", source = "HC: Sethekk Halls", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30563, name = "Regal Tanzanite", icon = "inv_jewelcrafting_nightseye_03", color = GemColor.BLUE, dodgeRating = 5, stamina = 6), note = "+5 Dodge / +6 Sta", source = "HC: Shadow Lab", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30555, name = "Glowing Tanzanite", icon = "inv_jewelcrafting_nightseye_03", color = GemColor.BLUE, stamina = 6), note = "+6 SP / +6 Sta", source = "HC: Black Morass", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30566, name = "Defender's Tanzanite", icon = "inv_jewelcrafting_nightseye_03", color = GemColor.BLUE, stamina = 6), note = "+5 Parry / +6 Sta", source = "HC: Mechanar", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30572, name = "Imperial Tanzanite", icon = "inv_jewelcrafting_nightseye_03", color = GemColor.BLUE, spirit = 5), note = "+9 Heal / +5 Spi", source = "HC: Botanica", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30574, name = "Brutal Tanzanite", icon = "inv_jewelcrafting_nightseye_03", color = GemColor.BLUE, attackPower = 10, stamina = 6), note = "+10 AP / +6 Sta", source = "HC: Botanica", quality = GemQuality.EPIC, heroicDrop = true),
        // Heroic dungeon drops — Green (duplicated in yellowGems)
        GemOption(Gem(id = 30592, name = "Steady Chrysoprase", icon = "inv_jewelcrafting_talasite_03", color = GemColor.BLUE, stamina = 6, resilienceRating = 5), note = "+6 Sta / +5 Resil", source = "HC: Ramparts", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30594, name = "Effulgent Chrysoprase", icon = "inv_jewelcrafting_talasite_03", color = GemColor.BLUE, defenseRating = 5), note = "+5 Def / +2 MP5", source = "HC: Ramparts", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30602, name = "Jagged Chrysoprase", icon = "inv_jewelcrafting_talasite_03", color = GemColor.BLUE, stamina = 6, critRating = 5), note = "+5 Crit / +6 Sta", source = "HC: Blood Furnace", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30548, name = "Polished Chrysoprase", icon = "inv_jewelcrafting_talasite_03", color = GemColor.BLUE, stamina = 6), note = "+6 Sta / +5 SP Crit", source = "HC: Shattered Halls", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30605, name = "Vivid Chrysoprase", icon = "inv_jewelcrafting_talasite_03", color = GemColor.BLUE, stamina = 6), note = "+5 SP Hit / +6 Sta", source = "HC: Slave Pens", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30606, name = "Lambent Chrysoprase", icon = "inv_jewelcrafting_talasite_03", color = GemColor.BLUE), note = "+5 SP Hit / +2 MP5", source = "HC: Underbog", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30608, name = "Radiant Chrysoprase", icon = "inv_jewelcrafting_talasite_03", color = GemColor.BLUE), note = "+5 SP Crit / +5 Spell Pen", source = "HC: Underbog", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30550, name = "Sundered Chrysoprase", icon = "inv_jewelcrafting_talasite_03", color = GemColor.BLUE, critRating = 5), note = "+5 Crit / +2 MP5", source = "HC: Steamvault", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30583, name = "Timeless Chrysoprase", icon = "inv_jewelcrafting_talasite_03", color = GemColor.BLUE, intellect = 5, stamina = 6), note = "+5 Int / +6 Sta", source = "HC: Mana-Tombs", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30586, name = "Seer's Chrysoprase", icon = "inv_jewelcrafting_talasite_03", color = GemColor.BLUE, intellect = 4, spirit = 5), note = "+4 Int / +5 Spi", source = "HC: Auchenai Crypts", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30560, name = "Rune Covered Chrysoprase", icon = "inv_jewelcrafting_talasite_03", color = GemColor.BLUE), note = "+5 SP Crit / +2 MP5", source = "HC: Shadow Lab", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30589, name = "Dazzling Chrysoprase", icon = "inv_jewelcrafting_talasite_03", color = GemColor.BLUE, intellect = 5), note = "+5 Int / +2 MP5", source = "HC: Old Hillsbrad", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30590, name = "Enduring Chrysoprase", icon = "inv_jewelcrafting_talasite_03", color = GemColor.BLUE, stamina = 6, defenseRating = 5), note = "+5 Def / +6 Sta", source = "HC: Old Hillsbrad", quality = GemQuality.EPIC, heroicDrop = true),
    )
    ...
    private val yellowGems = listOf(
        ...
        // Heroic dungeon drops — Orange (duplicated in redGems)
        GemOption(Gem(id = 30593, name = "Iridescent Fire Opal", icon = "inv_jewelcrafting_nobletopaz_03", color = GemColor.YELLOW), note = "+11 Heal / +4 SP Crit", source = "HC: Ramparts", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30601, name = "Beaming Fire Opal", icon = "inv_jewelcrafting_nobletopaz_03", color = GemColor.YELLOW, dodgeRating = 5, resilienceRating = 4), note = "+5 Dodge / +4 Resil", source = "HC: Blood Furnace", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30547, name = "Luminous Fire Opal", icon = "inv_jewelcrafting_nobletopaz_03", color = GemColor.YELLOW, intellect = 4), note = "+11 Heal / +4 Int", source = "HC: Shattered Halls", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30604, name = "Resplendent Fire Opal", icon = "inv_jewelcrafting_nobletopaz_03", color = GemColor.YELLOW, strength = 5, resilienceRating = 4), note = "+5 Str / +4 Resil", source = "HC: Slave Pens", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30607, name = "Splendid Fire Opal", icon = "inv_jewelcrafting_nobletopaz_03", color = GemColor.YELLOW, resilienceRating = 4), note = "+5 Parry / +4 Resil", source = "HC: Underbog", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30551, name = "Infused Fire Opal", icon = "inv_jewelcrafting_nobletopaz_03", color = GemColor.YELLOW, intellect = 4), note = "+6 SP / +4 Int", source = "HC: Steamvault", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30584, name = "Enscribed Fire Opal", icon = "inv_jewelcrafting_nobletopaz_03", color = GemColor.YELLOW, strength = 5, critRating = 4), note = "+5 Str / +4 Crit", source = "HC: Mana-Tombs", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30585, name = "Glistening Fire Opal", icon = "inv_jewelcrafting_nobletopaz_03", color = GemColor.YELLOW, agility = 4, defenseRating = 5), note = "+4 Agi / +5 Def", source = "HC: Mana-Tombs", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30587, name = "Champion's Fire Opal", icon = "inv_jewelcrafting_nobletopaz_03", color = GemColor.YELLOW, strength = 5, defenseRating = 4), note = "+5 Str / +4 Def", source = "HC: Auchenai Crypts", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30588, name = "Potent Fire Opal", icon = "inv_jewelcrafting_nobletopaz_03", color = GemColor.YELLOW), note = "+6 SP / +4 SP Crit", source = "HC: Auchenai Crypts", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30553, name = "Pristine Fire Opal", icon = "inv_jewelcrafting_nobletopaz_03", color = GemColor.YELLOW, attackPower = 10, hitRating = 4), note = "+10 AP / +4 Hit", source = "HC: Sethekk Halls", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30554, name = "Stalwart Fire Opal", icon = "inv_jewelcrafting_nobletopaz_03", color = GemColor.YELLOW, defenseRating = 5, dodgeRating = 4), note = "+5 Def / +4 Dodge", source = "HC: Sethekk Halls", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30559, name = "Etched Fire Opal", icon = "inv_jewelcrafting_nobletopaz_03", color = GemColor.YELLOW, strength = 5, hitRating = 4), note = "+5 Str / +4 Hit", source = "HC: Shadow Lab", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30591, name = "Empowered Fire Opal", icon = "inv_jewelcrafting_nobletopaz_03", color = GemColor.YELLOW, attackPower = 8, resilienceRating = 5), note = "+8 AP / +5 Resil", source = "HC: Old Hillsbrad", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30556, name = "Glinting Fire Opal", icon = "inv_jewelcrafting_nobletopaz_03", color = GemColor.YELLOW, agility = 5, hitRating = 4), note = "+5 Agi / +4 Hit", source = "HC: Black Morass", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30558, name = "Glimmering Fire Opal", icon = "inv_jewelcrafting_nobletopaz_03", color = GemColor.YELLOW, defenseRating = 4), note = "+5 Parry / +4 Def", source = "HC: Black Morass", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30564, name = "Shining Fire Opal", icon = "inv_jewelcrafting_nobletopaz_03", color = GemColor.YELLOW), note = "+6 SP / +5 SP Hit", source = "HC: Mechanar", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30565, name = "Assassin's Fire Opal", icon = "inv_jewelcrafting_nobletopaz_03", color = GemColor.YELLOW, critRating = 6, dodgeRating = 5), note = "+6 Crit / +5 Dodge", source = "HC: Mechanar", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30573, name = "Mysterious Fire Opal", icon = "inv_jewelcrafting_nobletopaz_03", color = GemColor.YELLOW), note = "+6 SP / +5 Spell Pen", source = "HC: Botanica", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30575, name = "Nimble Fire Opal", icon = "inv_jewelcrafting_nobletopaz_03", color = GemColor.YELLOW, dodgeRating = 5, hitRating = 4), note = "+5 Dodge / +4 Hit", source = "HC: Arcatraz", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30581, name = "Durable Fire Opal", icon = "inv_jewelcrafting_nobletopaz_03", color = GemColor.YELLOW, resilienceRating = 4), note = "+11 Heal / +4 Resil", source = "HC: Arcatraz", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30582, name = "Deadly Fire Opal", icon = "inv_jewelcrafting_nobletopaz_03", color = GemColor.YELLOW, attackPower = 8, critRating = 5), note = "+8 AP / +5 Crit", source = "HC: Arcatraz", quality = GemQuality.EPIC, heroicDrop = true),
        // Heroic dungeon drops — Green (duplicated in blueGems)
        GemOption(Gem(id = 30592, name = "Steady Chrysoprase", icon = "inv_jewelcrafting_talasite_03", color = GemColor.YELLOW, stamina = 6, resilienceRating = 5), note = "+6 Sta / +5 Resil", source = "HC: Ramparts", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30594, name = "Effulgent Chrysoprase", icon = "inv_jewelcrafting_talasite_03", color = GemColor.YELLOW, defenseRating = 5), note = "+5 Def / +2 MP5", source = "HC: Ramparts", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30602, name = "Jagged Chrysoprase", icon = "inv_jewelcrafting_talasite_03", color = GemColor.YELLOW, stamina = 6, critRating = 5), note = "+5 Crit / +6 Sta", source = "HC: Blood Furnace", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30548, name = "Polished Chrysoprase", icon = "inv_jewelcrafting_talasite_03", color = GemColor.YELLOW, stamina = 6), note = "+6 Sta / +5 SP Crit", source = "HC: Shattered Halls", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30605, name = "Vivid Chrysoprase", icon = "inv_jewelcrafting_talasite_03", color = GemColor.YELLOW, stamina = 6), note = "+5 SP Hit / +6 Sta", source = "HC: Slave Pens", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30606, name = "Lambent Chrysoprase", icon = "inv_jewelcrafting_talasite_03", color = GemColor.YELLOW), note = "+5 SP Hit / +2 MP5", source = "HC: Underbog", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30608, name = "Radiant Chrysoprase", icon = "inv_jewelcrafting_talasite_03", color = GemColor.YELLOW), note = "+5 SP Crit / +5 Spell Pen", source = "HC: Underbog", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30550, name = "Sundered Chrysoprase", icon = "inv_jewelcrafting_talasite_03", color = GemColor.YELLOW, critRating = 5), note = "+5 Crit / +2 MP5", source = "HC: Steamvault", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30583, name = "Timeless Chrysoprase", icon = "inv_jewelcrafting_talasite_03", color = GemColor.YELLOW, intellect = 5, stamina = 6), note = "+5 Int / +6 Sta", source = "HC: Mana-Tombs", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30586, name = "Seer's Chrysoprase", icon = "inv_jewelcrafting_talasite_03", color = GemColor.YELLOW, intellect = 4, spirit = 5), note = "+4 Int / +5 Spi", source = "HC: Auchenai Crypts", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30560, name = "Rune Covered Chrysoprase", icon = "inv_jewelcrafting_talasite_03", color = GemColor.YELLOW), note = "+5 SP Crit / +2 MP5", source = "HC: Shadow Lab", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30589, name = "Dazzling Chrysoprase", icon = "inv_jewelcrafting_talasite_03", color = GemColor.YELLOW, intellect = 5), note = "+5 Int / +2 MP5", source = "HC: Old Hillsbrad", quality = GemQuality.EPIC, heroicDrop = true),
        GemOption(Gem(id = 30590, name = "Enduring Chrysoprase", icon = "inv_jewelcrafting_talasite_03", color = GemColor.YELLOW, stamina = 6, defenseRating = 5), note = "+5 Def / +6 Sta", source = "HC: Old Hillsbrad", quality = GemQuality.EPIC, heroicDrop = true),
    )
